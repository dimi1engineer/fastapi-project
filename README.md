...
[![codecov](https://codecov.io/gh/dimi1engineer/fastapi-project/branch/main/graph/badge.svg?token=fastapi-project_token_here)](https://codecov.io/gh/dimi1engineer/fastapi-project)
[![CI](https://github.com/dimi1engineer/fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/dimi1engineer/fastapi-project/actions/workflows/main.yml)

Awesome fastapi_project created by dimi1engineer

## Install

from source
```bash
git clone https://github.com/dimi1engineer/fastapi-project fastapi_project
cd fastapi_project
make install
```
